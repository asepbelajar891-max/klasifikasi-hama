...
def predict():
    ...
    try:
        ...
        # --- Logika Ambang Batas "Saya Tidak Tahu" ---
        if top_prediction["score"] < 30:
            # Jangan hapus file di sini, karena mungkin pengguna ingin melihatnya
            return jsonify({
                "status": "uncertain",
                "message": "Tidak Dapat Diidentifikasi. Skor kecocokan terlalu rendah. (Dibawah 30%) Pastikan gambar jelas, fokus, dan diambil dalam pencahayaan yang baik.",
